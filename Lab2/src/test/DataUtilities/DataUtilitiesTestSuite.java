...
public class DataUtilitiesTestSuite {
    ...
    public void testCalculateColumnTotal_ValidData_ColumnNegative() {
        ...
        assertThrows(IndexOutOfBoundsException.class, () -> {
    		DataUtilities.calculateColumnTotal(validData, -40);
        });
    }
    ...
    public void testCalculateColumnTotal_ValidData_ColumnOutBoundPositive() {
        // Test Case #3
        assertThrows(IndexOutOfBoundsException.class, () -> {
    		DataUtilities.calculateColumnTotal(validData, 3);
        });
    }
    ...
    public void testCalculateColumnTotal_NullData_Column0() {
    	...
    	assertThrows(IllegalArgumentException.class, () -> {
    		DataUtilities.calculateColumnTotal(nullData, -40);
        });
    }
    ...
    public void testCalculateRowTotal_ValidData_Row1() {
        ...
        assertEquals("Expected -1.0 for row index 1", 4.0, result, 0.0);
    }
